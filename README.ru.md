...
[Сайт](https://mavicat.kailingteck.com/) · [Releases](https://github.com/aitiangua876/mavicat/releases) · [Issues](https://github.com/aitiangua876/mavicat/issues) · [Contributing](./CONTRIBUTING.md)
...
- **Новый визуальный стиль Mavicat**: более насыщенные иконки toolbar, чистый workspace в духе Navicat и единая light/dark theme.
...
- [Последний release](https://github.com/aitiangua876/mavicat/releases/latest)
- [Скачать с официального сайта](https://mavicat.kailingteck.com/)
...
Спасибо open-source проекту [Tabularis](https://github.com/TabularisDB/tabularis) за раннюю работу и вдохновение.

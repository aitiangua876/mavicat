...
[公式サイト](https://mavicat.kailingteck.com/) · [Releases](https://github.com/chenlong/Mavicat/releases) · [Issues](https://github.com/chenlong/Mavicat/issues) · [Contributing](./CONTRIBUTING.md)
...
Mavicat は、プロ向けデータベースクライアントで慣れ親しんだワークフローを、モダンでローカルファーストなデスクトップアプリとして再構築するプロジェクトです。Tauri v2、Rust、React、TypeScript により、ネイティブな操作感と柔軟な UI を両立します。
...
- **オープンで拡張可能**: Apache-2.0、Tabularis を基盤に開発。
...
Mavicat は Apache-2.0 の [Tabularis](https://github.com/TabularisDB/tabularis) を基盤にしています。Mavicat は Navicat、TablePlus、DataGrip、DBeaver などの製品とは提携していません。名称は一般的なワークフロー説明のためにのみ使用しています。

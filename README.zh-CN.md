...
Mavicat 希望把商业数据库客户端里高频、顺手、专业的工作流，做成一个现代、轻量、本地优先、可持续开源的桌面工具。它基于 Tauri v2、Rust、React 和 TypeScript 构建，既有原生桌面应用的手感，也保留了前端界面的迭代速度。
...
- **开放可扩展**：Apache-2.0 许可证，基于 Tabularis 的成熟基础继续演进。
...
- 类 Navicat 的左侧连接树，清晰显示连接、数据库、表和状态。
...
Mavicat 基于 Apache-2.0 许可证的 [Tabularis](https://github.com/TabularisDB/tabularis) 继续构建，并保留原始许可证声明。Mavicat 与 Navicat、TablePlus、DataGrip、DBeaver 等产品没有从属关系，文中提及仅用于描述大家熟悉的数据库工具工作流。
